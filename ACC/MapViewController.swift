...
class MapViewController: UIViewController, DataProcessorDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        NotificationCenter.default.addObserver(self, selector: #selector(receiveDataSource(notification:)), name:Notification.Name(rawValue: "dataSource"), object: nil)
        
        // Objects setup
        gradientView.colorSetUp(topColor: UIColor.white.cgColor, bottomColor: UIColor.yellow.withAlphaComponent(0.5).cgColor)
